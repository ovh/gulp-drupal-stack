...
module.exports = (gulp, config, tasks) => {
  ...
  gulp.task('spritesvg:util', () => { return createSpriteSvg(config.spritesvg.iconUtil.options.src, config.spritesvg.iconUtil.options.prefix, config.spritesvg.iconUtil.options.outputFileName, svgoIconUtilityConf) });
  gulp.task('spritesvg:illu', () => { return createSpriteSvg(config.spritesvg.iconIllustration.options.src, config.spritesvg.iconIllustration.options.prefix, config.spritesvg.iconIllustration.options.outputFileName, svgoIconIllustrationConf) });
