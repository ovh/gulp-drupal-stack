...
module.exports = (gulp, config, tasks) => {
  ...
  function compileJs(done) {
    gulp.src(config.js.src)
      .pipe(gulpif(config.js.sourceMap.enabled, sourcemaps.init()))
      .pipe(gulpif(config.js.babel, babel())) // all babel options handled in `.babelrc`
      .pipe(gulpif(config.js.concat, concat(config.js.destName)))
      .pipe(gulpif(config.js.uglify, uglify()))
      .pipe(gulpif(config.js.sourceMap.enabled, sourcemaps.write((config.js.sourceMapEmbed) ? null : './')))
