...
// Note: Order is important (reference in comments below), what's added is what's not default state
const svgoIconIllustrationConf = [
  // leave { removeXMLNS: false } at default false it cause issue with class name (does not append prefix) so we have to leave it false (<style> is needed for illustration type)
   {
     cleanupIDs: 
     {
       force: true
